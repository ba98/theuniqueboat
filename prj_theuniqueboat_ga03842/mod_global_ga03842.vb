Module mod_global_ga03842

    Public username As String
    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_THEUNIQUEBOAT_GA03842.accdb;Persist Security Info=False;"
